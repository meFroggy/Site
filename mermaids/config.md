...
| "ConfigVersion"                           | 9                                                  | Current Version when you have loaded for the plugin.                                                                                                                                |
| "PluginName"                              | "Mermaids"                                         | Plugin name.                                                                                                                                                                        |
| "Version"                                 | "1.4.1"                                            | Version of the last ran mod jar.                                                                                                                                                    |
| "Website"                                 | "https://mermaids.dev/mermaids/"                   | Official website for the Mermaids mod.                                                                                                                                              |
